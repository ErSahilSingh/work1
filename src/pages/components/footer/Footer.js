        ...
        <>
            <footer className="page-footer font-small pt-4">
                ...
                <div className="row">
                    ...
                    <p className="">Delectus voluptatum distinctio quos eius excepturi sunt pariatur, aut, doloribus officia ea molestias beatae laudantium, quam odio ipsum veritatis est maiores velit quasi blanditiis et natus accusamus itaque. Veniam quidem debitis odio amet voluptas distinctio dicta placeat! Et pariatur doloremque ea veniam. Separated they live.</p>
                    <h5> Connect with us</h5>
                    <ul className=" btn__1  py-3">
                       
                       
                       <li >
                       <a   href="#" className="text-dark btn me-2"><FaFacebookF/></a>
                       </li>
                       <li >
                       <a   href="#" className="text-dark btn me-2"><FaTwitter/></a>
                       </li>
                       <li >
                       <a   href="#" className="text-dark btn me-2"><FaInstagram/></a>
                       </li>  
                       <li >
                       <a   href="#" className="text-dark btn me-2"><FaGlobe/></a>
                       </li>  
                       <li >
                       <a   href="#" className="text-dark me-2 btn"><FaLinkedin/></a>
                       </li> 
                   </ul>
                    ...
                    <h5 className="  mb-4  ">Navigations</h5>
